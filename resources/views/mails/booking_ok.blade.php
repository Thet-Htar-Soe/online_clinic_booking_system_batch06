                    ...
                    <div class="card-body px-5">
                        ...
                        <div class="row ">
                            <div class="col-12 border-bottom border-info border-3 pb-3">
                                <p>Dear Mr. Mg Mg,</p>
                                <p>This is booking confirm from Dr. Doctor Name. Odit distinctio quo repudiandae sapiente
                                    ipsum aspernatur nostrum esse, voluptatum quam facilis, asperiores dolorem animi neque
                                    quidem necessitatibus voluptatibus dolorum ad blanditiis!</p>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-8">
